...
public class SimpleOrderSystem
{
  public static void main(String[] args)
  {
    ...
    SimpleOrderSystemView ui
      = new SimpleOrderSystemTerminalUI(in,model);
    OrderEntryController orderEntryController
      = new OrderEntryController(model,ui);
    CustomerEntryController customerEntryController
            = new CustomerEntryController(model, ui);
    ui.addOrderEntryController(orderEntryController);
    ui.addCustomerEntryController(customerEntryController);
  ...
  public static void initialiseExampleData(SimpleOrderSystemModel model)
  {
    ...
    Collections.addAll(quantities, new Integer[]{19, 12});
    model.constructInventory(quantities);
