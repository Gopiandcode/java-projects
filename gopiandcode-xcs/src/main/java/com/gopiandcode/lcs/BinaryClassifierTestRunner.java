...
public class BinaryClassifierTestRunner {
    ...
    public BinaryClassifierTestRunner(BinaryClassifierDataset train_dataset, BinaryClassifierDataset test_dataset, BinaryClassifier classifier) {
        ...
        while(i < count) {
            ...
            if(loggingFrequency.isPresent() && logger.isPresent()) {
                if(i != 0 && (i % loggingFrequency.get()) == 0) {
                  ...
                  logger.get().recordAccuracyAtIteration(ratioCorrect * 100, i);
